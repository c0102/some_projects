...
#define SDA_PIN                            (0) /*16 on demo*/
#define SCL_PIN                            (5) /*17 on demo*/
...
ATCA_STATUS hal_i2c_send(ATCAIface iface, uint8_t *txdata, int txlength)
{
    ...
    txlength++;
    //ESP_LOGI(TAG, "%s: txdata: %p , txlength: %d", __FUNCTION__, txdata, txlength);
...
{
    ESP_LOGW(TAG, "hal_i2c_discover_buses:ATCA_UNIMPLEMENTED");
    return ATCA_UNIMPLEMENTED;
}

ATCA_STATUS hal_i2c_discover_devices(int bus_num, ATCAIfaceCfg *cfg, int *found)
{
    ESP_LOGW(TAG, "hal_i2c_discover_devices:ATCA_UNIMPLEMENTED");
    return ATCA_UNIMPLEMENTED;
}
